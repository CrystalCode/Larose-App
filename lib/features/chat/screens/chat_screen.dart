...
import 'package:crystal_code/features/chat/widgets/message_bubble_widget.dart';
import 'package:crystal_code/features/chat/widgets/message_bubble_shimmer_widget.dart';
...
class _ChatScreenState extends State<ChatScreen> {
  ...
  void initState() {
    ...
    if (!kIsWeb) {
      FirebaseMessaging.onMessage.listen((RemoteMessage message) {
        Provider.of<ChatProvider>(context, listen: false)
            .getMessages(1, widget.orderModel?.id, false);
      });
    }
    _isLoggedIn =
    ...
    if (_isLoggedIn) {
      if (_isFirst) {
        Provider.of<ChatProvider>(context, listen: false)
            .getMessages(1, widget.orderModel?.id, true);
      } else {
        Provider.of<ChatProvider>(context, listen: false)
            .getMessages(1, widget.orderModel?.id, false);
        _isFirst = false;
                      ...
                      child: ClipRRect(
                        ...
                        child: FadeInImage.assetNetwork(
                          ...
                          imageErrorBuilder: (c, t, o) => Image.asset(
                              isAdmin ? Images.logo : Images.profile),
                        ),
                      ),
                    ),
                  )

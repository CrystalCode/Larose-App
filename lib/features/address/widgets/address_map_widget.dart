...
import 'package:crystal_code/common/widgets/custom_asset_image_widget.dart';
...
import 'package:crystal_code/features/address/widgets/location_permission_dialog_widget.dart';
                    ...
                    children: [
                      ...
                      Positioned(
                        ...
                        child: InkWell(
                          ...
                          child: Container(
                            width:
                                ResponsiveHelper.isDesktop(context) ? 40 : 30,
                            height:
                                ResponsiveHelper.isDesktop(context) ? 40 : 30,
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      borderRadius:
                          BorderRadius.circular(Dimensions.paddingSizeSmall),
                      border: Border.all(
                        color: addressProvider.selectAddressIndex == index
                            ? Theme.of(context).primaryColor
                    ...
                    child: Text(
                      getTranslated(
                          addressProvider.getAllAddressType[index]
                              .toLowerCase(),
                          context),
                      style: rubikMedium.copyWith(
                        color: addressProvider.selectAddressIndex == index

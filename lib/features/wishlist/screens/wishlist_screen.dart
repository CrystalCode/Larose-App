...
import 'package:crystal_code/features/wishlist/widgets/wish_list_shimmer_widget.dart';
              ...
              builder: (context, wishlistProvider, child) {
                return wishlistProvider.isLoading
                    ...
                    : !wishlistProvider.isLoading &&
                            wishlistProvider.wishIdList.isEmpty
                        ? NoDataScreen(
                            showFooter: true,
                            title: getTranslated(
                                'no_favourite_added_yet', context),

...
import 'package:crystal_code/features/address/widgets/address_widget.dart';
...
class AddAddressDialogWidget extends StatelessWidget {
  final bool listing;
  const AddAddressDialogWidget({Key? key, required this.listing})
      : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return Dialog(child:
        Consumer<AddressProvider>(builder: (context, locationProvider, _) {
      bool isNotEmptyAddress = (locationProvider.addressList != null &&
      ...
      return Container(
        ...
        child: Column(mainAxisSize: MainAxisSize.min, children: [
          ...
          Text(
            getTranslated(
                isNotEmptyAddress
                    ? 'select_form_saved_address'
                    : 'you_have_to_save_address',
                context),
          ...
          TextButton.icon(
            onPressed: () async {
              ...
              await Navigator.pushNamed(context,
                  Routes.getAddAddressRoute('checkout', 'add', AddressModel()));
            ...
            label: Text(getTranslated('add_new_address', context),
...
class CurrentLocationButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return TextButton.icon(
      ...
      label: Text(getTranslated('use_my_current_location', context),

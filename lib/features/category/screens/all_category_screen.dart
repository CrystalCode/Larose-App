...
import 'package:crystal_code/features/category/widgets/category_item_widget.dart';
import 'package:crystal_code/features/category/widgets/sub_categories_shimmer_widget.dart';
...
class _AllCategoryScreenState extends State<AllCategoryScreen> {
          ...
          child: SizedBox(
              ...
              child: Consumer<CategoryProvider>(
                builder: (context, categoryProvider, child) {
                  ...
                  } else if (categoryProvider.categoryList != null &&
                              ...
                              child: ListView.builder(
                                ...
                                itemBuilder: (context, index) {
                                  return ListTile(
                                    ...
                                    title: Text(
                                      index == 0
                                          ? '${categoryProvider.categoryList![categoryProvider.categoryIndex].totalProductQuantity}+ ${getTranslated('products', context)}'
                                          : categoryProvider
                                              .subCategoryList![index - 1]
                                              .name!,
  ...
  _load() async {
    ...
    if (categoryProvider.categoryList!.isNotEmpty &&
        categoryProvider.categoryList![0].id != null) {
      categoryProvider
          .getSubCategoryList(categoryProvider.categoryList![0].id!);
    }
  }
}

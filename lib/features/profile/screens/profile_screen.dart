...
import 'package:crystal_code/features/profile/enums/login_medium_enum.dart';
import 'package:crystal_code/main.dart';
import 'package:crystal_code/features/profile/widgets/profile_web_widget.dart';
...
import 'package:crystal_code/common/widgets/custom_text_field_widget.dart';
                                    ...
                                    children: [
                                      ...
                                      CustomTextFieldWidget(
                                        ...
                                        hintText: getTranslated(
                                            'number_hint', context),
                                        isShowBorder: true,
                                        isEnabled: (splashProvider.configModel
                                                    ?.emailVerification ??
                                                false) ||
                                            profileProvider.userInfoModel
                                                    ?.loginMedium !=
                          ...
                          child: CustomButtonWidget(
                            ...
                            onTap: () async {
                              ...
                              if (didNotChange) {
                                showCustomSnackBar(
                                    getTranslated(
                                        'change_something_to_update', context),
                                    context);
                                ...
                                if (responseModel.isSuccess) {
                                  ...
                                  showCustomSnackBar(
                                      getTranslated(
                                          'updated_successfully', Get.context!),
                                      Get.context!,
                                      isError: false);
                                } else {
                                  showCustomSnackBar(
                                      responseModel.message, Get.context!);
                                }
                              }
                            },
                          ),

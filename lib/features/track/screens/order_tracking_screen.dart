...
import 'package:crystal_code/common/widgets/custom_loader_widget.dart';
...
import 'package:crystal_code/features/track/widgets/custom_stepper_widget.dart';
import 'package:crystal_code/features/track/widgets/delivery_man_widget.dart';
import 'package:crystal_code/features/track/widgets/tracking_map_widget.dart';
...
class OrderTrackingScreen extends StatefulWidget {
  ...
  const OrderTrackingScreen(
      {Key? key, required this.orderID, required this.fromOrderList})
      : super(key: key);
...
class _OrderTrackingScreenState extends State<OrderTrackingScreen> {
  ...
  void initState() {
    ...
    Provider.of<OrderProvider>(context, listen: false)
        .getTrackOrder(widget.orderID, null, true);
    Provider.of<OrderProvider>(context, listen: false)
        .updateDeliveryManData(widget.orderID);
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar:
          CustomAppBarWidget(title: getTranslated('order_tracking', context)),
          ...
          children: [
            ConstrainedBox(
              constraints: BoxConstraints(
                  minHeight:
                      !ResponsiveHelper.isDesktop(context) && size.height < 600
                          ? size.height
                          : size.height - 400),
              child: Padding(
                    ...
                    return status != null
                        ? RefreshIndicator(
                            ...
                            onRefresh: () async {
                              ...
                              await orderProvider
                                  .getDeliveryManData(widget.orderID);
                              await orderProvider.getTrackOrder(
                                  widget.orderID, null, true);
                            },
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            Container(
                                              ...
                                              child: Row(
                                                ...
                                                children: [
                                                  Expanded(
                                                    child: Text(
                                                        '${getTranslated('order_id', context)} #${order.trackModel!.id}',
                                            ...
                                            const SizedBox(
                                                height: Dimensions
                                                    .paddingSizeSmall),
                                            order.trackModel!.deliveryAddress !=
                                                    null
                                                ? Container(

...
import 'package:crystal_code/features/coupon/widgets/coupon_custom_painter_widget.dart';
                                      ...
                                      child: StaggeredGrid.count(
                                        crossAxisCount:
                                            ResponsiveHelper.isDesktop(context)
                                                ? 3
                                                : 1,
                                        children: couponProvider.couponList!
                                            .map((couponModel) => CustomPaint(
                                                  size: Size(
                                                                ...
                                                                children: [
                                                                  Container(
                                                                    ...
                                                                    child: Row(
                                                                        children: [
                                                                          Text(
                                                                            '${couponModel.discount}${couponModel.discountType == 'percent' ? '%' : Provider.of<SplashProvider>(context, listen: false).configModel!.currencySymbol}',
                                                                            style:
                                                                                rubikBold.copyWith(color: Colors.white, fontSize: Dimensions.fontSizeExtraLarge),
                                                                          ),
                                                                          const SizedBox(
                                                                              width: Dimensions.paddingSizeExtraSmall),
                                                                          Text(
                                                                              getTranslated('off', context).toUpperCase(),

...
import 'package:crystal_code/features/notification/domain/models/payload_model.dart';
...
import 'package:crystal_code/features/notification/widgets/notifiation_popup_dialog_widget.dart';
...
class NotificationHelper {
  static Future<void> initialize(
      ...
      onDidReceiveNotificationResponse:
        ...
        try {
          if (notificationResponse.payload!.isNotEmpty) {
            if (payload.type == 'listing-order') {
              Get.navigator?.push(MaterialPageRoute(
                  builder: (context) => const SellListingScreen()));
    ...
    FirebaseMessaging.onMessage.listen((RemoteMessage message) {
      ...
      } else if (message.data['type'] == 'listing-order') {
        Provider.of<SellProvider>(Get.context!, listen: false)
            .getUserListing(1, isUpdate: true, limit: 10);
      } else {

import 'dart:convert';
import 'package:crystal_code/common/enums/html_type_enum.dart';
import 'package:crystal_code/common/models/product_model.dart';
import 'package:crystal_code/features/address/screens/address_screen.dart';
import 'package:crystal_code/features/address/screens/select_location_screen.dart';
import 'package:crystal_code/features/category/screens/category_screen.dart';
import 'package:crystal_code/features/checkout/screens/checkout_screen.dart';
import 'package:crystal_code/features/order/screens/order_successful_screen.dart';
import 'package:crystal_code/features/payment/screens/payment_screen.dart';
import 'package:crystal_code/features/payment/screens/order_web_payment.dart';
import 'package:crystal_code/features/coupon/screens/coupon_screen.dart';
import 'package:crystal_code/features/forgot_password/screens/create_new_password_screen.dart';
import 'package:crystal_code/features/forgot_password/screens/forgot_password_screen.dart';
import 'package:crystal_code/features/forgot_password/screens/verification_screen.dart';
import 'package:crystal_code/features/flash_sale/screens/flash_sale_details_screen.dart';
import 'package:crystal_code/features/sell/screens/add_listing_screen.dart';
import 'package:crystal_code/features/sell/screens/sell_listing_screen.dart';
import 'package:crystal_code/helper/email_checker_helper.dart';
import 'package:crystal_code/main.dart';
import 'package:crystal_code/common/enums/search_short_by_enum.dart';
import 'package:crystal_code/features/splash/providers/splash_provider.dart';
import 'package:crystal_code/features/category/screens/all_category_screen.dart';
import 'package:crystal_code/features/order/screens/order_screen.dart';
import 'package:crystal_code/features/product/screens/product_details_screen.dart';
import 'package:crystal_code/features/product/screens/product_image_screen.dart';
import 'package:crystal_code/features/update/screens/update_screen.dart';
import 'package:fluro/fluro.dart';
import 'package:flutter/material.dart';
import 'package:crystal_code/common/models/address_model.dart';
import 'package:crystal_code/common/models/order_model.dart';
import 'package:crystal_code/utill/routes.dart';
import 'package:crystal_code/common/widgets/map_widget.dart';
import 'package:crystal_code/common/widgets/not_found.dart';
import 'package:crystal_code/features/address/screens/add_new_address_screen.dart';
import 'package:crystal_code/features/auth/screens/create_account_screen.dart';
import 'package:crystal_code/features/auth/screens/login_screen.dart';
import 'package:crystal_code/features/chat/screens/chat_screen.dart';
import 'package:crystal_code/features/dashboard/screens/dashboard_screen.dart';
import 'package:crystal_code/features/html/screens/html_viewer_screen.dart';
import 'package:crystal_code/features/language/screens/choose_language_screen.dart';
import 'package:crystal_code/features/notification/screens/notification_screen.dart';
import 'package:crystal_code/features/onboarding/screens/onboarding_screen.dart';
import 'package:crystal_code/features/order/screens/order_details_screen.dart';
import 'package:crystal_code/features/profile/screens/profile_screen.dart';
import 'package:crystal_code/features/rate_review/screens/rate_review_screen.dart';
import 'package:crystal_code/features/search/screens/search_result_screen.dart';
import 'package:crystal_code/features/search/screens/search_screen.dart';
import 'package:crystal_code/features/splash/screens/splash_screen.dart';
import 'package:crystal_code/features/support/screens/support_screen.dart';
import 'package:crystal_code/features/track/screens/order_tracking_screen.dart';
import 'package:crystal_code/features/welcome_screen/screens/welcome_screen.dart';
import 'package:crystal_code/features/maintanance/screens/maintainance_screen.dart';
...
//*******Handlers*********
  ...
  static final Handler _languageHandler =
  ...
  static final Handler _productImagesHandler = Handler(
    ...
    return productImageScreen ??
        ProductImageScreen(imageList: jsonDecode(params['images'][0]));
  });

  static final Handler _verificationHandler =
      Handler(handlerFunc: (context, Map<String, dynamic> params) {
  ...
  static final Handler _createNewPassHandler =
      Handler(handlerFunc: (context, Map<String, dynamic> params) {
  ...
  static final Handler _createAccountHandler =
      Handler(handlerFunc: (context, Map<String, dynamic> params) {
  ...
  static final Handler _searchResultHandler =
      Handler(handlerFunc: (context, Map<String, dynamic> params) {
    ...
    return SearchResultScreen(
      searchString: data,
      shortBy: shortBy.isEmpty || shortBy == 'null'
          ? null
          : SearchShortBy.values.byName(shortBy),
    );
  });

  static final Handler _categoryHandler =
      Handler(handlerFunc: (context, Map<String, dynamic> params) {
    return CategoryScreen(
      categoryId: int.tryParse(params['id'][0]),
      subCategoryId: '${params['sub_id'][0]}' == '-1'
          ? null
          : int.tryParse(params['sub_id'][0]),
    );
  });
  ...
  static final Handler _paymentHandler =
      Handler(handlerFunc: (context, Map<String, dynamic> params) {
  ...
  static final Handler _rateReviewHandler =
      Handler(handlerFunc: (context, Map<String, dynamic> params) {
    RateReviewScreen? rateReviewScreen =
        ModalRoute.of(context!)!.settings.arguments as RateReviewScreen?;
    return rateReviewScreen ?? const NotFound();
  });

  static final Handler _orderTrackingHandler =
      Handler(handlerFunc: (context, Map<String, dynamic> params) {
    return OrderTrackingScreen(
      orderID: params['id'][0],
      fromOrderList: '${params['route'][0]}'.contains('1'),
    );
  });
  ...
  static final Handler _flashSaleDetailsHandler = Handler(
      handlerFunc: (BuildContext? context, Map<String, dynamic> params) {
  ...
  static final Handler _orderListHandler = Handler(
      handlerFunc: (BuildContext? context, Map<String, dynamic> params) {
    return _routeHandler(child: const OrderScreen());
  });

  static final Handler _sellListHandler = Handler(
      handlerFunc: (BuildContext? context, Map<String, dynamic> params) {
    return _routeHandler(child: const SellListingScreen());
  });

  static final Handler _addListingHandler = Handler(
      handlerFunc: (BuildContext? context, Map<String, dynamic> params) {
    return _routeHandler(child: const AddListingScreen());
  });

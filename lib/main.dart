...
import 'dart:async';
import 'dart:io';
import 'package:crystal_code/common/widgets/cookies_widget.dart';
...
import 'package:crystal_code/helper/notification_helper.dart';
import 'package:crystal_code/helper/responsive_helper.dart';
import 'package:crystal_code/helper/router_helper.dart';
...
import 'package:crystal_code/common/widgets/third_party_chat_widget.dart';
...
import 'package:crystal_code/localization/app_localization.dart';
...
import 'package:crystal_code/theme/dark_theme.dart';
import 'package:crystal_code/theme/light_theme.dart';
...
Future<void> main() async {
  ...
  if (kIsWeb) {
    await Firebase.initializeApp(
        options: const FirebaseOptions(
            apiKey: "AIzaSyBRobgZqIC-",
            authDomain: "-e420c.firebaseapp.com",
            projectId: "-e420c",
            storageBucket: "-e420c.appspot.com",
  ...
  runApp(MultiProvider(
    providers: [
      ...
      ChangeNotifierProvider(create: (context) => di.sl<SellProvider>()),
    ],

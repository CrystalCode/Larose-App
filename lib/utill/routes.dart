...
import 'package:crystal_code/common/models/place_order_model.dart';
import 'package:crystal_code/common/models/address_model.dart';
import 'package:crystal_code/common/models/category_model.dart';
...
class Routes {
  ...
  static const String sellList = '/sell-list';
  ...
  static String getNewPassRoute(String? email, String token) =>
      '$createNewPassScreen?email=$email&token=$token';
  ...
  static String getProductImageRoute(String images) =>
  ...
  static String getOrderTrackingRoute(int? id, {bool fromOrderList = true}) =>
      '$orderTrackingScreen?id=$id&route=${fromOrderList ? 1 : 0}';
  ...
  static String getSellListingScreen() => sellList;
  static String getAddListing() => addListing;
}

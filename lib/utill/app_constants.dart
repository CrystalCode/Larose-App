...
class AppConstants {
  static const String appName = 'larose';
  static const double appVersion = 7.3;
  static const AppMode appMode = AppMode.release;
  static const String fontFamily = 'Exo';
  static const String baseUrl = 'https://laroze.crystalcodekw.com';
  ...
  static const String getUserListing = '/api/v1/customer/user-listing/list';
  static const String storeUserListing = '/api/v1/customer/user-listing/store';

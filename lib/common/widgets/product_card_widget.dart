...
class ProductCardWidget extends StatelessWidget {
  ...
  const ProductCardWidget(
      {Key? key, required this.product, this.direction = Axis.vertical})
      : super(key: key);
    ...
    return Column(
        ...
        children: [
          ...
          Row(
            ...
            children: [
              Text(
                '${getTranslated('Karat', context)}: ${product.karat?.toString() ?? ''}',
              )
            ],
          ),
          Row(
            ...
            children: [
              Text(
                '${getTranslated('Weight', context)}: ${product.weight?.toString() ?? ''}',
              )
            ],
          ),
          Row(
            ...
            children: [
              Text(
                '${getTranslated('Country', context)}: ${product.country?.toString() ?? ''}',
              )
            ],
          )
        ]);

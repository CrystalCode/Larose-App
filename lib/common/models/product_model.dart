...
class Product {
  ...
  int? get karat => _karat;
  double? get weight => _weight;
  double? get makingCharge => _makingCharge;
  ...
  Product.fromJson(Map<String, dynamic> json) {
    ...
    _makingCharge = double.tryParse(json["makingCharge"]);
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    data['karat'] = _karat;
    data['weight'] = _weight;
    data['makingCharge'] = _makingCharge;

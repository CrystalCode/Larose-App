...
class BaseUrls {
  ...
  BaseUrls({
    ...
    _userListingImageUrl = userListingImageUrl;
  }
  ...
  String? get getUserListingImageUrl => _userListingImageUrl;
  ...
  BaseUrls.fromJson(Map<String, dynamic> json) {
    ...
    _userListingImageUrl = json['user_listing_image_url'];
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    data['user_listing_image_url'] = _userListingImageUrl;
    return data;
  }
}
